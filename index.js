...
function removeFlavorByName(arr, remove){
    let removeFromArray = arr.indexOf(remove)
...
function filterByWord(arr, searchWord){
    let searchedArray = [];
    for (i in arr) {
      if(arr[i].includes(searchWord) === true) {
        searchedArray.push(arr[i])
      }
    }
...
let a = filterByWord(originalFlavors, "Chocolate")
